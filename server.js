...
/* ===== MOCK EARLY HANDLER (ROOT): /api/search ===== */
app.post("/api/search", (req, res) => {
  ...
  const items = [
    { id:"MOCK1", airlineName:"AeroDemo", airline:"AeroDemo", origin, destination:dest, dest, price:{ amount:1299, currency:"MXN" }, price_mxn:1299, departureTime:"2025-09-01T08:00:00-06:00", depart_at:"2025-09-01T08:00:00-06:00", arrivalTime:"2025-09-01T09:45:00-06:00", arrive_at:"2025-09-01T09:45:00-06:00", durationMinutes:105, duration_min:105, stops:0 },
    { id:"MOCK2", airlineName:"AeroDemo", airline:"AeroDemo", origin, destination:dest, dest, price:{ amount:1499, currency:"MXN" }, price_mxn:1499, departureTime:"2025-09-01T18:00:00-06:00", depart_at:"2025-09-01T18:00:00-06:00", arrivalTime:"2025-09-01T19:45:00-06:00", arrive_at:"2025-09-01T19:45:00-06:00", durationMinutes:105, duration_min:105, stops:0 }
  ];
  return res.json({ ok:true, msg:`Búsqueda recibida: ${origin} → ${dest}`, count:items.length, hasResults:items.length>0, results:items, flights:items, data:{ items } });
});
/* ===== END MOCK EARLY HANDLER (ROOT) ===== */
