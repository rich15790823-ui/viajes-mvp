export async function placesHandler(req,res){
  res.json([
    ...
    {"id":"MID","code":"MID","name":"Manuel Crescencio Rejón","city":"Mérida","country":"Mexico","type":"airport"},
    {"id":"MTY","code":"MTY","name":"Gral. Mariano Escobedo","city":"Monterrey","country":"Mexico","type":"airport"}
  ]);
}
